...
/**
 *  测试排他网关(都为true时,走节点id更小的节点)  每次执行步骤3时,观察act_ru_task表
 *      已经加入了排他网关来进行测试
 */
public class ExclusiveGateWayTest02 {
    ...
    public static void main1(String[] args) {
        ...
        ProcessInstance processInstance = runtimeService.
                startProcessInstanceByKey("holidayExclusive",map);
    ...
    public static void main2(String[] args) {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("diagram/day05/holiday05.bpmn") //添加bpmn资源
                .addClasspathResource("diagram/day05/holiday05.png")
                .name("请假申请单流程")
                .deploy();
